...
Vvveb.ComponentsGroup['Grid Elements'] =
...
Vvveb.Components.extend("_base", "_base", {
	 properties: [{
		...
		sort: base_sort++,
		section: style_section,
		data: {header:"Dimensions", expanded:false},
	}, {
        name: "Width",
        key: "width",
		htmlAttr: "style",
...
Vvveb.Components.extend("_base", "_base", {
	 properties: [{
		...
		sort: base_sort++,
		section: style_section,
		data: {header:"Background Settings", expanded:false},
	 }, {
        name: "Background Color",
        key: "background-color",
        sort: base_sort++,
...
Vvveb.Components.extend("_base", "html/container", {
    ...
    html: '<div class="container" style="min-height:100px;"><div class="inner-container" style="min-height:80px;">This is Container and you can write your text here or drag any element here.</div></div>',
    name: "Container",
    properties: [
     {
        name: "Type",

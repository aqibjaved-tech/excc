...
Vvveb.Components.extend("_base", "widgets/video", {
    ...
    html: '<section data-component-video style="height:370px;min-width:240px;position:relative"><iframe frameborder="0" src="https://www.youtube.com/embed/-stFvGmg1A8" style="width:100%;height:100%;position:absolute;left:0px;pointer-events:none"></iframe></section>',
	...
	onChange: function (node, property, value)
	{
		...
		//if (property.key == "t")
		{
			switch (this.t)
			{
				...
				$("#right-panel [data-key=url]").hide();
				newnode = $('<section data-component-video style="height:370px;min-width:240px;position:relative"><iframe src="https://www.youtube.com/embed/' + this.video_id + '?&amp;autoplay=' + this.autoplay + '&amp;controls=' + this.controls + '&amp;loop=' + this.loop + '" allowfullscreen="true" style="height: 100%; width: 100%;" frameborder="0"></iframe></section>');
				break;
				case 'v':
				$("#right-panel [data-key=video_id]").show();
				$("#right-panel [data-key=url]").hide();
				newnode = $('<section data-component-video style="height:370px;min-width:240px;position:relative"><iframe src="https://player.vimeo.com/video/' + this.video_id + '?&amp;autoplay=' + this.autoplay + '&amp;controls=' + this.controls + '&amp;loop=' + this.loop + '" allowfullscreen="true" style="height: 100%; width: 100%;" frameborder="0"></iframe></section>');
				break;
				case 'h':
				$("#right-panel [data-key=video_id]").hide();
				$("#right-panel [data-key=url]").show();
				newnode = $('<section data-component-video style="height:370px;min-width:240px;position:relative"><video src="' + this.url + '" ' + (this.controls?' controls ':'') + (this.loop?' loop ':'') + ' style="height: 100%; width: 100%;"></video></section>');
				break;
			}

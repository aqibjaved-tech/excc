          ...
          <div class="modal-content">
            ...
            <div class="modal-body text">
              ...
              <div class="form-group row" data-key="href">
                ...
                <div class="col-sm-9 input">
                  <div>
                    <input name="pageTitle" type="text" class="form-control" placeholder="My page" required>
                  </div>
                </div>
              </div>
              <div class="form-group row" data-key="href">
                ...
                <div class="col-sm-9 input">
                  <div>
                    <input name="pageFileName" type="text" class="form-control" placeholder="my-page.html" required>
                  </div>
                </div>
              </div>
            </div>

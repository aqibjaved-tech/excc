                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form action="{{{URL::to('')}}}/admin/addtermscondition"  class="form-horizontal" role="form" method="post">
                                        <div class="form-body">
                                            ...
                                            <label class="control-label col-md-3">Terms & Conditions Number
                                                ...
                                                <div class="col-md-4">
                                                    <input class="form-control" name="tcnumber" type="text"> </div>
                                            </div>    
                                            <div class="form-group last">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="ckeditor form-control" name="tctext" rows="6" ></textarea>

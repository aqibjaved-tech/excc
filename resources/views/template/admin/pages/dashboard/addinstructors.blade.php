           ...
           @include('template/admin/parts/sidebarmenu')
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"> instructor List
                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Add instructor</span>
                                    </div>
                                    ...
                                    <form class="form-horizontal"  action="{{{URL::to('')}}}/admin/addinstructor" role="form" method="post">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="instructor_fname">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="instructor_lname">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="instructor_email" > </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="instructor_phone" > </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="instructor_phone_type" >

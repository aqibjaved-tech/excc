                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red sbold uppercase">Add Institute</span>
                                    </div>
                                    
                                </div>
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form class="form-horizontal"  action="{{{URL::to('')}}}/admin/addinstitute" role="form" method="post">
                                        <div class="form-body">
                                            ...
                                            <label class="control-label col-md-3">Service User Name
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="service_user_name" > </div>
                                                </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                               <label class="control-label col-md-3">Institute Type
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="institute_type" > </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="institute_address" > </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="institute_website" > </div>
                                            </div>
                                            <div class="form-group">

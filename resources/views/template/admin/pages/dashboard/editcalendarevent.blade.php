                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form ">
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form class="form-horizontal"  action="{{{URL::to('')}}}/admin/updatecalendarevent" role="form" method="post">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    value="{{{$data['classes'] ['class_id']}}}"> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="class_titile" value="{{{$data['classes'] ['class_titile']}}}"> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="class_description" value="{{{$data['classes'] ['class_description']}}}">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="class_date" value="{{{$data['classes'] ['class_date']}}}"> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="institute_id">
                                                  ...
                                                  @foreach($data['institutes'] as $institutes) 
                                                    ...
                                                    @if($institutes['institute_id']== $data['classes']['institute_id']) {{{'selected="selected"'}}} @endif>
                                           ...
                                           <div class="form-group">
                                                <label class="control-label col-md-3">Assigned Student</label>
                                                <div class="col-md-4">
                                                <select class="form-control" name="student_master_id">
                                                  ...
                                                  @foreach($data['students'] as $students) 
                                                    ...
                                                    @if($students['student_master_id']== $data['classes']['student_master_id']) {{{'selected="selected"'}}} @endif>

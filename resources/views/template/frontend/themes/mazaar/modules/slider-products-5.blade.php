            <div class="product-item-5 owl-carousel owl-theme product-slider">
                <!--Item-->
                <div class="item">
                    <div class="product-item">
                        ...
                        <div class="product-item-img">
                            ...
                            <a class="product-item-img-link">
                                <img src="/assets/mazaar/img/products/02/01.jpg" alt="Product Item" />
                            </a>
                            <!--Add to Link-->
                        ...
                        <div class="product-item-content">
                            ...
                            <a href="product_detail.html" class="product-item-title"><span>Short Sleeve Blouse</span></a>
                ...
                <div class="item">
                    <div class="product-item">
                        ...
                        <div class="product-item-img">
                            <!--Image-->
                            <a class="product-item-img-link">
                                <img src="/assets/mazaar/img/products/12/01.jpg" alt="Product Item" />
                            </a>
                            <!--Add to Link-->
                            <div class="add-to-link">
                ...
                <div class="item">
                    <div class="product-item">
                        ...
                        <div class="product-item-img">
                            <!--Image-->
                            <a class="product-item-img-link">
                                <img src="/assets/mazaar/img/products/08/01.jpg" alt="Product Item" />
                            </a>
                            <!--Add to Link-->
                            <div class="add-to-link">
                                <a class="btn btn--primary btn--sm">Add To Cart</a>
                ...
                <div class="item">
                    <div class="product-item">
                        ...
                        <div class="product-item-img">
                            <!--Image-->
                            <a class="product-item-img-link">
                                <img src="/assets/mazaar/img/products/04/01.jpg" alt="Product Item" />
                            </a>
                            <!--Add to Link-->
                            <div class="add-to-link">
                                <a class="btn btn--primary btn--sm">Add To Cart</a>
                ...
                <div class="item">
                    <div class="product-item">
                        ...
                        <div class="product-item-img">
                            <!--Image-->
                            <a class="product-item-img-link">
                                <img src="/assets/mazaar/img/products/05/01.jpg" alt="Product Item" />
                            </a>
                            <!--Add to Link-->
                            <div class="add-to-link">
                                <a class="btn btn--primary btn--sm">Add To Cart</a>
                ...
                <div class="item">
                    <div class="product-item">
                        ...
                        <div class="product-item-img">
                            <!--Image-->
                            <a class="product-item-img-link">
                                <img src="/assets/mazaar/img/products/06/01.jpg" alt="Product Item" />
                            </a>
                            <!--Add to Link-->
                            <div class="add-to-link">
                                <a class="btn btn--primary btn--sm">Add To Cart</a>
                ...
                <div class="item">
                    <div class="product-item">
                        ...
                        <div class="product-item-img">
                            <!--Image-->
                            <a class="product-item-img-link">
                                <img src="/assets/mazaar/img/products/07/01.jpg" alt="Product Item" />
                            </a>
                            <!--Add to Link-->
                            <div class="add-to-link">
                                <a class="btn btn--primary btn--sm">Add To Cart</a>

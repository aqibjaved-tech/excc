<!-- BEGIN HEAD -->
        ...
        <meta charset="utf-8" />
        <title>SiiMii | Account Verification</title>
        ...
        <link href="{{{URL::to('public')}}}/assets/layouts/layout2/css/layout.min.css" rel="stylesheet" type="text/css" />
        <link href="{{{URL::to('public')}}}/assets/layouts/layout2/css/themes/blue.min.css" rel="stylesheet" type="text/css" id="style_color" />
        <link href="{{{URL::to('public')}}}/assets/layouts/layout2/css/custom.min.css" rel="stylesheet" type="text/css" />
